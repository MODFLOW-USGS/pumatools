...
namespace USGS.Puma.FiniteDifference
{
    ...
    /// </summary>
    /// <remarks></remarks>
    public class TriangleContourEngine
    {
        #region Fields
        TriangulatedNetwork _TIN;
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <remarks></remarks>
        public TriangleContourEngine(CellCenteredArealGrid grid) : this()
        { 
            Grid = grid;
        }
        #endregion
        ...
        public TriangulatedNetwork TIN
        {
            get
            {
                return _TIN;
