...
{
    public class PathlineFileWriter : IDisposable
    {
        private StringBuilder sb;
        private string e15Fmt = "   0.000000E+00";

        public PathlineFileWriter()
        {
            sb = new StringBuilder();
        }

        public string CreateTextRecord(PathlineRecord record)
        {
            sb.Length = 0;
            sb.Capacity = 200;
            ...
            sb.Append(record.TimePoint.ToString().PadLeft(7));
            ...
            sb.Append(record.LineNumber.ToString().PadLeft(5));
