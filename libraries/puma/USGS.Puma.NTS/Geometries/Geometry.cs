...
using USGS.Puma.NTS.Operation.Relate;
using USGS.Puma.NTS.Operation.Distance;
using USGS.Puma.NTS.Operation.Buffer;
using USGS.Puma.NTS.Operation.Valid;
using USGS.Puma.NTS.Operation.Predicate;
...
{   
    ...
    {        
        ...
        // The following code adds support for calculating the bounding Z
        // values, which are needed to export 3d ESRI shapefiles.

        /// <summary>
        /// 
        /// </summary>
        protected IVerticalEnvelope verticalEnvelope;

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        protected virtual IVerticalEnvelope ComputeVerticalEnvelopeInternal()
        {
            return new VerticalEnvelope() as IVerticalEnvelope;
        }

        /// <summary>
        /// 
        /// </summary>
        public IVerticalEnvelope VerticalEnvelopeInternal
        {
            get
            {
                if (verticalEnvelope == null)
                    verticalEnvelope = ComputeVerticalEnvelopeInternal();
