...
using USGS.Puma.NTS.Planargraph.Algorithm;
...
namespace USGS.Puma.NTS.Operation.Linemerge
{
    ...
    public class LineSequencer
    {
        ...
        public static bool IsSequenced(IGeometry geom)
        {
            ...
            Iesi_NTS.Collections.Generic.ISet<ICoordinate> prevSubgraphNodes = new Iesi_NTS.Collections.Generic.SortedSet<ICoordinate>();
