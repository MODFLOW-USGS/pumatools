...
namespace USGS.Puma.NTS.IO
{
	...
	public class ShapefileHeader
	{
		...
		public ShapefileHeader(BigEndianBinaryReader shpBinaryReader)
		{
            ...
            //read in and store the vertical bounds
            double minZ = shpBinaryReader.ReadDouble();
            double maxZ = shpBinaryReader.ReadDouble();
            _VerticalBounds = new VerticalEnvelope(minZ, maxZ);
        ...
        private IVerticalEnvelope _VerticalBounds;
        /// <summary>
        /// Gets and sets the bounds of the bounds of the shapefile
        /// in the z dimension.
        /// </summary>
        public IVerticalEnvelope VerticalBounds
        {
            get { return _VerticalBounds; }
            set { _VerticalBounds = value; }
        }
		...
		public void Write(BigEndianBinaryWriter file) 
		{
            ...
            {
                file.Write(VerticalBounds.MinZ);
                file.Write(VerticalBounds.MaxZ);
                pos += 16;
            }
            else
            {
