...
namespace USGS.Puma.NTS.IO
{
	...
	public class ShapefileWriter
	{
		...
		public void Write(string filename, IGeometryCollection geometryCollection)
		{
            ...
            // get the vertical envelope in external coordinates
            IVerticalEnvelope ve = (geometryCollection as GeometryCollection).VerticalEnvelopeInternal;
            IVerticalEnvelope vbounds = new VerticalEnvelope(ve.MinZ, ve.MaxZ) as IVerticalEnvelope;
            shpHeader.VerticalBounds = vbounds;
            ...
            shxHeader.VerticalBounds = vbounds;
