...
namespace USGS.Puma.NTS.IO
{
	...
	public class ShapefileDataReader : IDataReader, IDataRecord, IEnumerable, IDisposable
	{
        ...
        {
            string[] names = new string[_dbaseFields.Length];
		...
		public object this[string name]
		{
			get
			{
                ...
                // The preceding line is not correct for the current version of the
                // code. The following line works correctly. No adjustment is needed.
