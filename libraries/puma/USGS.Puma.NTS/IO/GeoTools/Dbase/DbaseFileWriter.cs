...
namespace USGS.Puma.NTS.IO
{
    ...
    public class DbaseFileWriter
    {
        ...
        public void Write(IList columnValues)
        {
            ...
            foreach (object columnValue in columnValues)
            {
                ...
                if (columnValue == null)
                    ...
                    Write((float)columnValue, headerField.Length, headerField.DecimalCount);
                else if (columnValue is double)
                    Write((double)columnValue, headerField.Length, headerField.DecimalCount);
        ...
        {
            string decimalString = new string('0', decimalCount);
            string strFormat = "0." + decimalString + "e+000";
            string outString = number.ToString(strFormat);
        ...
        {
            Write(Convert.ToDouble(number), length, decimalCount);
        }
