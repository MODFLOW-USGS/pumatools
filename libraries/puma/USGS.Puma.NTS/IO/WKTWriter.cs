...
namespace USGS.Puma.NTS.IO
{
    ...
    public class WKTWriter 
    {
        ...
        /// </summary>
        /// <param name="precisionModel">The <c>PrecisionModel</c> used to determine
        /// the number of decimal places to write.</param>
        /// <returns>A <c>NumberFormatInfo</c> that write <c>double</c>
        /// s without scientific notation.</returns>
        /// <remarks></remarks>
        ...
        /// </summary>
        /// <param name="geometry">A <c>Geometry</c> to process</param>
        /// <param name="isFormatted">if set to <c>true</c> [is formatted].</param>
        /// <param name="writer">The writer.</param>
        /// <returns>A "Geometry Tagged Text" string (see the OpenGIS Simple
        ...
        /// <param name="precisionModel">The <c>PrecisionModel</c> to use to convert
        ...
        /// <returns>The <see cref="double"/> as a <see cref="string"/>,
        /// not in scientific notation.</returns>
        /// <remarks></remarks>
        ...
        /// <param name="lineString">The <c>LineString</c> to process.</param>
        /// <param name="level">The level.</param>
        /// <param name="doIndent">if set to <c>true</c> [do indent].</param>
        /// <param name="writer">The output writer to append to.</param>
        /// <remarks></remarks>
        ...
        /// <param name="polygon">The <c>Polygon</c> to process.</param>
        /// <param name="level">The level.</param>
        /// <param name="indentFirst">if set to <c>true</c> [indent first].</param>
        /// <param name="writer">The output writer to append to.</param>
        /// <remarks></remarks>
