...
{
    public class UnstructuredBudgetRecord : UnstructuredBudgetRecordHeader
    {
        ...
        public UnstructuredBudgetRecord(UnstructuredBudgetRecordHeader recordHeader)
        {
        ...
        private void SetData(int[] layerIndicator)
        {
            ...
            else
            {
                if (Method == 3)
                {
                    if (layerIndicator.Length != Count)
                    {
                        throw new ArgumentException("The size of the specified array is incorrect.");
                    }
