...
namespace GeoAPI.Geometries
{
    ...
    public class IntersectionMatrix
    {
        ...
        /// </summary>
        /// <param name="actualDimensionValue">A number that can be stored in the <see cref="IntersectionMatrix"/>.
        ...
        /// <returns><c>true</c> if the dimension symbol encompasses the dimension value.</returns>
        /// <remarks></remarks>
        ...
        /// </summary>
        /// <param name="actualDimensionSymbols">Nine dimension symbols to validate.
        /// Possible values are <c>T, F, * , 0, 1, 2</c>.</param>
        /// <param name="requiredDimensionSymbols">Nine dimension symbols to validate
        /// against. Possible values are <c>T, F, * , 0, 1, 2</c>.</param>
        /// <returns><c>true</c> if each of the required dimension
        ...
        /// </summary>
        /// <param name="row">The row of this <see cref="IntersectionMatrix"/>,
        /// indicating the interior, boundary or exterior of the first <see cref="IGeometry"/></param>
        /// <param name="column">The column of this <see cref="IntersectionMatrix"/>,
        /// indicating the interior, boundary or exterior of the second <see cref="IGeometry"/></param>
        ...
        /// </summary>
        /// <param name="dimensionSymbols">Nine dimension symbols to which to set this <see cref="IntersectionMatrix"/>
        /// s elements. Possible values are <c>{T, F, * , 0, 1, 2}</c></param>
        /// <remarks></remarks>
        ...
        /// <param name="column">The column of this <see cref="IntersectionMatrix"/>,
        /// indicating the interior, boundary or exterior of the second <see cref="IGeometry"/>.</param>
        /// <param name="minimumDimensionValue">The dimension value with which to compare the
        /// element. The order of dimension values from least to greatest is
        /// <c>True, False, Dontcare, 0, 1, 2</c>.</param>
        /// <remarks></remarks>
        ...
        /// <param name="minimumDimensionValue">The minimum dimension value.</param>
        /// <remarks></remarks>
        ...
        /// order of dimension values from least to greatest is <c>Dontcare, True, False, 0, 1, 2</c>.</param>
        /// <remarks></remarks>
        ...
        /// </summary>
        /// <param name="dimensionValue">The dimension value to which to set this <see cref="IntersectionMatrix"/>
        /// s elements. Possible values <c>True, False, Dontcare, 0, 1, 2}</c>.</param>
        /// <remarks></remarks>
        ...
        /// elements.
        /// </summary>
        /// <param name="row">The row of this <see cref="IntersectionMatrix"/>, indicating
        /// the interior, boundary or exterior of the first <see cref="IGeometry"/>.</param>
        /// <param name="column">The column of this <see cref="IntersectionMatrix"/>,
        /// indicating the interior, boundary or exterior of the second <see cref="IGeometry"/>.</param>
        ...
        /// </summary>
        /// <returns><c>true</c> if the two <see cref="IGeometry"/>'s related by
        /// this <see cref="IntersectionMatrix"/> are disjoint.</returns>
        /// <remarks></remarks>
        ...
        /// </summary>
        /// <returns><c>true</c> if the two <see cref="IGeometry"/>'s related by
        /// this <see cref="IntersectionMatrix"/> intersect.</returns>
        /// <remarks></remarks>
        ...
        /// <returns><c>true</c> if the two <see cref="IGeometry"/>
        /// s related by this <see cref="IntersectionMatrix"/> touch; Returns false
        /// if both <see cref="IGeometry"/>s are points.</returns>
        /// <remarks></remarks>
        ...
        /// function to return <c>true</c>, the <see cref="IGeometry"/>s must
        /// be two points, two curves or two surfaces.</returns>
        /// <remarks></remarks>
        ...
        /// values are <c>{T, F, * , 0, 1, 2}</c>.</param>
        /// <returns><c>true</c> if this <see cref="IntersectionMatrix"/>
        /// matches the required dimension symbols.</returns>
        /// <remarks></remarks>
        ...
        /// </summary>
        /// <returns>The nine dimension symbols of this <see cref="IntersectionMatrix"/>
        /// in row-major order.</returns>
        /// <remarks></remarks>
