...
namespace GeoAPI.CoordinateSystems
{
    ...
    /// </summary>
    /// <remarks>For the OGC abstract model, it can be defined as a set of real points on the earth
