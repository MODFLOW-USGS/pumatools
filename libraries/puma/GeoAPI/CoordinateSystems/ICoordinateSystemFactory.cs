...
namespace GeoAPI.CoordinateSystems
{
    ...
    /// </summary>
    /// <remarks><para>ICoordinateSystemFactory allows applications to make coordinate systems that
    ...
    /// lets an application create such a hybrid coordinate system.</para></remarks>
	public interface ICoordinateSystemFactory
	{
        ...
        /// <param name="toBaseWkt">To base WKT.</param>
        /// <param name="arAxes">The ar axes.</param>
        ...
        /// <remarks>Since this method contains a set of Bursa-Wolf parameters, the created
        ...
        /// either specify a <see cref="DatumType">horizontalDatumType</see> of <see cref="DatumType.HD_Other"/>, or create it via WKT.</remarks>
        ...
        /// <remarks>The dimension of the local coordinate system is determined by the size of
        ...
        /// coordinate system from different local coordinate systems.</remarks>
