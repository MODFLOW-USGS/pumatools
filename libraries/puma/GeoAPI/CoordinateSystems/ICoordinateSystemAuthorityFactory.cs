...
namespace GeoAPI.CoordinateSystems
{
    ...
    /// </summary>
    /// <remarks>The codes are maintained by an external authority. A commonly used authority is EPSG, which is also used in the GeoTIFF standard and in SharpMap.</remarks>
	public interface ICoordinateSystemAuthorityFactory
	{
        ...
        /// <returns></returns>
        /// <remarks>In the OGC definition of WKT horizontal datums, the geoid is referenced
        /// by a quoted string, which is used as a key value. This method converts
        /// the key value string into a code recognized by this authority.</remarks>
		string GeoidFromWktName(string wkt);

        /// <summary>
        /// Gets the WKT name of a Geoid.
        /// </summary>
        /// <param name="geoid">The geoid.</param>
        /// <returns></returns>
        /// <remarks>In the OGC definition of WKT horizontal datums, the geoid is referenced by
        /// a quoted string, which is used as a key value. This method gets the OGC WKT
        /// key value from a geoid code.</remarks>
